package com.fo_product.merchant_service.controllers.product;
...
public class ProductController {
    ...
    @Operation(summary = "Lấy danh sách sản phẩm theo id của sản phẩm", description = "Lấy toàn bộ món ăn theo Id")
    @GetMapping("/products")
    APIResponse<List<ProductResponse>> getAllProductsByIds(
            @Parameter(description = "Danh sách Id của phân loại thực đơn", example = "[1,2,3,4]")
